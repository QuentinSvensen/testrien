/**
 * useShoppingList — Hook de gestion de la liste de courses.
 *
 * CRUD complet pour les tables shopping_groups et shopping_items :
 * - Groupes : ajout, renommage, suppression, réordonnancement
 * - Articles : ajout, suppression, renommage, toggle coché, quantité, marque,
 *   contenu (Nb), type de contenu (g/#), coches secondaires (vérification menu)
 * - Réordonnancement des articles entre groupes via drag & drop
 *
 * Types exportés : ShoppingGroup, ShoppingItem
 */
