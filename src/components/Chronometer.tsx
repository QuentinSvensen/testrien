/**
 * Chronomètre — Composant de minuteur persistant.
 *
 * Affiche un chronomètre (HH:MM:SS) dans un dialog modal.
 * L'état (en cours / en pause / accumulé) est sauvegardé dans les
 * préférences utilisateur en base, ce qui permet de retrouver le
 * temps même après un rechargement de page.
 *
 * Fonctions principales :
 * - handleStart()  → Démarre ou reprend le chronomètre
 * - handlePause()  → Met en pause et sauvegarde le temps écoulé
 * - handleReset()  → Remet le compteur à zéro
 */
